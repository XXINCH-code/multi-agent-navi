...
agent_box_ids, agent_name_to_box_id, box_id_to_goal, agent_yaml_params = create_agents("./final_challenge/actors_single.yaml")
# cbs.run(dimensions=env_params["map"]["dimensions"], obstacles=env_params["map"]["obstacles"], agents=agent_yaml_params["agents"], out_file="./final_challenge/cbs_output_p1.yaml")
...
# cbs.run(dimensions=env_params["map"]["dimensions"], obstacles=env_params["map"]["obstacles"], agents=agent_yaml_params["agents"], out_file="./final_challenge/cbs_output_p2.yaml")
# merge_yaml_files('./final_challenge/cbs_output_p1.yaml', './final_challenge/cbs_output_p2.yaml', './final_challenge/cbs_output.yaml')
...
run(agent_box_ids, box_id_to_goal, cbs_schedule[1])
time.sleep(2)