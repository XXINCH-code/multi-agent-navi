...
class Environment(object):
    ...
    # def state_valid(self, state):
    #     # Add size to check if any cell within the agent's bounding box is blocked or out of bounds
    #     radius = 0.2  # Assume the agent's size is given by `agent_size`
    #     for dx in np.arange(-radius, radius+1):
    #         for dy in np.arange(-radius, radius+1):
    #             x = state.location.x + dx
    #             y = state.location.y + dy
