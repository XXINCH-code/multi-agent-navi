...
def navigation(turtlebot_name, aruco_id, goal_list):
    ...
    while current_position_idx < len(goal_list) and not rospy.is_shutdown():
        ...
        max_linear_speed = 0.13  # meters per second
...
def main():
    ...
    try:
        ...
        coordinates = read_and_transform_waypoints("./cbs_output_2.yaml", matrix)
    except Exception as e:
    ...
    #navigation(turtlebot1_name,aruco1_id,coordinates[0])
